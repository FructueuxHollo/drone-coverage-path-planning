...
FLIGHT_ALTITUDE_M = 40;     % Altitude de vol en mètres
CAMERA_FOV_DEGREES = 60;    % Angle de vue de la caméra en degrés
...
tic;
py_mission_data = planner_module.planifier_mission(zone_a_surveiller{1}, FLIGHT_ALTITUDE_M, CAMERA_FOV_DEGREES, obstacles);
